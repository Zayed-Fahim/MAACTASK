        ...
        <table className="w-full rounded-lg table-fixed">
          <thead className="bg-[#f8f9fa] font-semibold text-left">
            <tr>
              ...
              <th className="py-2 font-[500] w-[120px]">Region</th>
              <th className="py-2 font-[500]">Area</th>
            </tr>
          </thead>
          <tbody>
            {areas?.map((area, index) => (
              ...
              >
                ...
                <td className="py-2">{area.region}</td>
                <td className="py-2">{area.area}</td>
              </tr>
            ))}
          </tbody>
        </table>
